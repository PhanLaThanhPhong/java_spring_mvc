                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                                ...
                                                                <form:input class="form-control ${not empty nameHasBindError?'is-invalid':''}" id="inputFirstName"
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                                ...
                                                                <form:input class="form-control ${not empty nameHasBindError?'is-invalid':''}" id="inputPassword"
